...
# question specific
    ...
    def test_meetup_is_instance_of_int(self):
        ...
        self.assertEqual(resp, True)
        resp = self.validt.x_instance_of(
            self.all_present_wrong_instace['meetup'], int)
        self.assertEqual(resp, False)
    ...
    def test_title_is_instance_of_int(self):
        ...
        self.assertEqual(resp, True)
        resp = self.validt.x_instance_of(
            self.all_present_wrong_instace['title'], str)
        self.assertEqual(resp, False)
    ...
    def test_body_is_instance_of_int(self):
        ...
        self.assertEqual(resp, True)
        resp = self.validt.x_instance_of(
            self.all_present_wrong_instace['body'], str)
        self.assertEqual(resp, False)
    ...
    def test_votes_is_instance_of_int(self):
        ...
        self.assertEqual(resp, True)
        resp = self.validt.x_instance_of(
            self.all_present_wrong_instace['votes'], int)
        self.assertEqual(resp, False)
...
# meetup specific
    ...
    def test_images_is_instance_list(self):
        ...
        self.assertEqual(resp, True)
        resp = self.validt.x_instance_of(
            self.meetup_wrong_type['images'], list)
        self.assertEqual(resp, False)
    ...
    def test_happeningOn_is_instance_str(self):
        resp = self.validt.x_instance_of(
            self.meetup_provided['happeningOn'], str)
        self.assertEqual(resp, True)
        resp = self.validt.x_instance_of(
            self.meetup_wrong_type['happeningOn'], str)
        self.assertEqual(resp, False)
